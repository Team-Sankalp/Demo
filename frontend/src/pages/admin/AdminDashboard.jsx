        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Manage your telecom subscription system
            </p>
          </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">Manage Discounts</h3>
                    <p className="text-sm text-gray-500">Set up promotional discounts</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="text-center py-8">
                <p className="text-gray-500">
                  Admin management features will be implemented here.
                </p>
              </div>
            </div>
          </div>
